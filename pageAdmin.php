...
<body class="bg-black">
    ...
    if (isset($_GET['id'])) {
        ...
        unlink("gestionArticles/images/" . $currentImg);
                ...
                ?>
                    <div class=" card mx-auto mb-3" style="width: 18rem;">
                        ...
                        <div>
                            ...
                            <p class="card-text ms-3 mb-3">Date : <?= date('d-m-y H:i:s', strtotime($value->users_date)) ?></p>
                        </div>
                        <div class="text-center mb-3">
                            <a href="../pageAdmin.php?id=<?= $value->id_users ?>" class="btn btn-outline-dark">SUPPRIMER</a>
                            <a href="GestionARTICLES/modifier.php?id=<?= $value->id_users ?>" class="btn btn-outline-dark">MODIFIER</a>
                        </div>
                    </div>
                <?php
                }
